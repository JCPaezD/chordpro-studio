...
$EXPORT_TAGS{'MSW'} = [ qw(wxEXEC_HIDE_CONSOLE) ];
...
wxEXEC_NOEVENTS
wxEXEC_MAKE_GROUP_LEADER) ];
$EXPORT_TAGS{'execute,'} = [ qw(wxEXEC_HIDE_CONSOLE) ];
...
wxEVT_COMMAND_RIBBONTOOL_CLICKED
wxEVT_COMMAND_RIBBONTOOL_DROPDOWN_CLICKED) ];
$EXPORT_TAGS{'ribbonart'} = [ qw(wxRIBBON_ART_PANEL_Y_SEPARATION_SIZE
wxRIBBON_ART_TOOL_BACKGROUND_TOP_GRADIENT_COLOUR
wxRIBBON_ART_TOOL_HOVER_BACKGROUND_COLOUR
wxRIBBON_ART_GALLERY_BUTTON_ACTIVE_BACKGROUND_COLOUR
wxRIBBON_ART_GALLERY_BITMAP_PADDING_BOTTOM_SIZE
...
wxTOOL_STYLE_CONTROL
wxTOOL_STYLE_SEPARATOR) ];
$EXPORT_TAGS{'toolbook'} = [ qw(wxTBK_HORZ_LAYOUT
wxTBK_BUTTONBAR) ];
...
wxTREE_HITTEST_ONITEMLOWERPART
wxTREE_HITTEST_ONITEM) ];
$EXPORT_TAGS{'webview'} = [ qw(wxWEBVIEW_FIND_HIGHLIGHT_RESULT
wxWEBVIEW_ZOOM_TYPE_TEXT
wxWEBVIEW_ZOOM_TYPE_LAYOUT
wxWEBVIEW_ZOOM_MEDIUM
wxWEBVIEW_NAV_ERR_CONNECTION
...
$EXPORT_TAGS{'webview'} = [ qw(EVT_WEBVIEW_NAVIGATING
EVT_WEBVIEW_NAVIGATED
EVT_WEBVIEW_LOADED
EVT_WEBVIEW_ERROR
EVT_WEBVIEW_NEWWINDOW
