...
our $alien_key = 'msw_3_3_1_uni_gcc_3_4';

{
    my $VAR1;
    $Wx::dlls = $VAR1 = {
          'stc' => 'wxmsw331u_stc_gcc_custom.dll',
          'gl' => 'wxmsw331u_gl_gcc_custom.dll',
          'base' => 'wxbase331u_gcc_custom.dll',
          'core' => 'wxmsw331u_core_gcc_custom.dll',
          'xrc' => 'wxmsw331u_xrc_gcc_custom.dll',
          'propgrid' => 'wxmsw331u_propgrid_gcc_custom.dll',
          'media' => 'wxmsw331u_media_gcc_custom.dll',
          'webview' => 'wxmsw331u_webview_gcc_custom.dll',
          'ribbon' => 'wxmsw331u_ribbon_gcc_custom.dll',
          'richtext' => 'wxmsw331u_richtext_gcc_custom.dll',
          'net' => 'wxbase331u_net_gcc_custom.dll',
          'html' => 'wxmsw331u_html_gcc_custom.dll',
          'adv' => 'wxmsw331u_adv_gcc_custom.dll',
          'xml' => 'wxbase331u_xml_gcc_custom.dll',
          'aui' => 'wxmsw331u_aui_gcc_custom.dll'
        };
;
}

$VERSION = '3.008'; # bootstrap will catch wrong versions
$XS_VERSION = $VERSION;
...
sub _alien_path {
  ...
  return unless length 'msw_3_3_1_uni_gcc_3_4';
  foreach ( @INC ) {
    if( -d "$_/Alien/wxWidgets/msw_3_3_1_uni_gcc_3_4" ) {
      $wx_path = "$_/Alien/wxWidgets/msw_3_3_1_uni_gcc_3_4/lib";
      last;
    }
  }
