...
"MSWin32\-x64\-multi\-thread-10\.0\.22631\.5189" or
	die "Errno architecture (MSWin32\-x64\-multi\-thread-10\.0\.22631\.5189) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
