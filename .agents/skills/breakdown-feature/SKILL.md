...
Use the user's conversation language for conversation-only breakdowns; in this project, default to Spanish when the user is working in Spanish. Keep persistent documentation text in the target document's established language.
